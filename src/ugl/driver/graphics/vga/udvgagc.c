...
UGL_STATUS uglVgaGcSet(UGL_DEVICE_ID devId, UGL_GC_ID gc)
{
  UGL_VGA_DRIVER *pDrv;
  ...
  if (rasterOp != pDrv->rasterOp) {
    ...
    switch(rasterOp) {
      case UGL_RASTER_OP_COPY : UGL_OUT_WORD(0x3ce, 0x0003); break;
      case UGL_RASTER_OP_AND  : UGL_OUT_WORD(0x3ce, 0x0803); break;
      case UGL_RASTER_OP_OR   : UGL_OUT_WORD(0x3ce, 0x1003); break;
      case UGL_RASTER_OP_XOR  : UGL_OUT_WORD(0x3ce, 0x1803); break;
