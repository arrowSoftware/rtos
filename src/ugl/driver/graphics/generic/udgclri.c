...
UGL_STATUS uglGenericClutCreate(UGL_GENERIC_DRIVER *pDrv,
				UGL_SIZE numColors)
{
...
UGL_STATUS uglGenericClutSet(UGL_GENERIC_DRIVER *pDrv,
			     UGL_ORD offset,
			     UGL_ARGB *pColors,
			     UGL_SIZE numColors)
{
...
UGL_STATUS uglGenericClutGet(UGL_GENERIC_DRIVER *pDrv,
			     UGL_ORD offset,
			     UGL_ARGB *pColors,
			     UGL_SIZE numColors)
{
...
UGL_STATUS uglGenericClutMapNearest(UGL_GENERIC_DRIVER *pDrv,
				    UGL_ARGB *pMapColors,
...
UGL_STATUS uglGenericColorAllocIndexed(UGL_DEVICE_ID devId,
				       UGL_ARGB *pReqColors,
				       UGL_ORD *pIndex,
				       UGL_ARGB *pActualColors,
				       UGL_COLOR *pUglColors,
...
UGL_STATUS uglGenericColorFreeIndexed(UGL_DEVICE_ID devId,
				      UGL_COLOR *pColors,
				      UGL_SIZE numColors)
{
  UGL_GENERIC_DRIVER *pDrv;
...
UGL_STATUS uglGenericClutDestroy(UGL_GENERIC_DRIVER *pDrv)
{
