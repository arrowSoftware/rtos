...
/*******************************************************************************
 * uglGenericClipDdb - Clip for blit
 *
 * RETURNS: UGL_TRUE or UGL_FALSE
 ******************************************************************************/

UGL_STATUS uglGenericClipDdb(UGL_DEVICE_ID devId,
			     UGL_RECT *pClipRect,
			     ...
			     UGL_POINT *pDestPoint)
{
  ...
  UGL_RECT_SIZE_TO(destRect, UGL_RECT_WIDTH(srcRect), UGL_RECT_HEIGHT(srcRect));
...
/*******************************************************************************
 * uglGenericClipDibToDdb - Clip for write
 *
 * RETURNS: UGL_TRUE or UGL_FALSE
 ******************************************************************************/

UGL_BOOL uglGenericClipDibToDdb(UGL_DEVICE_ID devId,
				UGL_DIB *pDib,
				UGL_RECT *pSrcRect,
				UGL_BMAP_ID *pBmpId,
				UGL_POINT *pDestPoint)
