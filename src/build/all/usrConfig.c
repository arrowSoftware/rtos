...
extern SYMBOL standTable[];
extern int symTblAllSize;
extern SYMBOL symTblAll[];
extern void standTableInit(void);
...
void usrInit(void)
{
    ...
    historyLogStr((void*)usrInit, "usrInit", "Exit", 0);
}
...
void usrRoot(char *pMemPoolStart, unsigned memPoolSize)
{
    ...
    historyLogStr((void *)usrRoot, "usrRoot", "Entry: 0x%x, %d", pMemPoolStart, memPoolSize);
