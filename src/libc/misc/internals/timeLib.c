...
LOCAL void __tItostr(char *buffer, int num, int size);
...
int __julday(int yr, int mon, int day)
{
  static int jdays[12] = {
...
void __tmNormalize(int *tens, int *units, int base)
{
  *tens += *units / base;
...
void __tmValidate(struct tm *pTime)
{
  struct tm t;
  int jday, mon;
...
int __getDstInfo(struct tm *timeNow, TIMELOCALE *timeInfo)
{
  char *start, *end, *last;
  char *tmp, *envInfo;
  int monStart, monEnd;
...
void __getZoneInfo(char *buffer, int option, TIMELOCALE *timeInfo)
{
  char *envInfo;
  char *pLimitStart, *pLimitEnd;
...
void __generateTime(char *buffer, const struct tm *tmp,
...
void __getLocale(char *buffer, int desc, const struct tm *tmp,
...
void __getMonth(char *buffer, int index, int abbr,
		TIMELOCALE *timeInfo, int *size)
{
  char *pStr;
...
void __getDay(char *buffer, int index, int abbr,
	      TIMELOCALE *timeInfo, int *size)
{
  char *pStr;
...
int __weekOfYear (int start, int wday, int yday)
{
