...
extern TCB_ID taskIdCurrent;

static OBJ_CLASS fpClass;
static BOOL stdioLibInstalled = FALSE;
static BOOL stdioFpCleanupHookDone = FALSE;
static void stdioStdfpCleanup(TCB_ID tcbId);
 ...
 * RETURNS: OK or ERROR
 ******************************************************************************/
static STATUS stdioInitStd(int stdFd)
{
    FILE *fp;
