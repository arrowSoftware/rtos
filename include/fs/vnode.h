...
extern struct vnode *  vnodesCreate (struct mount *pMount, int isize,
                                     int nvnode);
extern void vnodesDelete (struct vnode *pVnodes, int nvnode);

extern STATUS vnodeLock (vnode_t *);
extern STATUS vnodeUnlock (vnode_t *);
